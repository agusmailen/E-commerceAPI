...
public class ProductoService {
    ...
    public List<ProductoDTO> obtenerTodosLosProductos(String categoria, String search, String sortBy, String sortDir) {
        Sort sort = Sort.by(Sort.Direction.fromString(sortDir != null ? sortDir : "asc"), 
                           sortBy != null ? sortBy : "nombre");
        
        List<Producto> productos;
        
        if (categoria != null && !categoria.equals("Todas") && search != null && !search.isEmpty()) {
